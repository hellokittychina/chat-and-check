          ...
          <Card className="max-w-4xl mx-auto bg-white p-8 shadow-md border-0">
            <div className="flex items-center mb-8">
              <div className="bg-interview/10 p-3 rounded-full">
                <FileText className="h-8 w-8 text-interview" />
              </div>
              <h1 className="text-3xl font-bold ml-4">{t("terms.title")}</h1>
            </div>
            ...
            <div className="prose max-w-none">
              ...
              <div className="mb-8 bg-gray-50 p-6 rounded-lg border-l-4 border-interview">
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">{t("terms.section1_title")}</h2>
              ...
              <div className="mb-8">
                ...
                <ul className="pl-10 space-y-2">
                  <li className="flex items-start text-gray-700">
                    ...
                    <span>{t("terms.section2_bullet1")}</span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <Check className="h-5 w-5 text-interview mr-2 shrink-0 mt-0.5" />
                    <span>{t("terms.section2_bullet2")}</span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <Check className="h-5 w-5 text-interview mr-2 shrink-0 mt-0.5" />
                    <span>{t("terms.section2_bullet3")}</span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <Check className="h-5 w-5 text-interview mr-2 shrink-0 mt-0.5" />
                    <span>{t("terms.section2_bullet4")}</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="pl-10 space-y-2">
                  <li className="flex items-start text-gray-700">
                    <Check className="h-5 w-5 text-interview mr-2 shrink-0 mt-0.5" />
                    <span>{t("terms.section4_bullet1")}</span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <Check className="h-5 w-5 text-interview mr-2 shrink-0 mt-0.5" />
                    <span>{t("terms.section4_bullet2")}</span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <Check className="h-5 w-5 text-interview mr-2 shrink-0 mt-0.5" />
                    <span>{t("terms.section4_bullet3")}</span>
                  </li>
                </ul>
              </div>
              
              <div className="mb-8 bg-gray-50 p-6 rounded-lg border-l-4 border-interview">
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">{t("terms.section5_title")}</h2>
                <p className="text-gray-700">
                  {t("terms.section5_p1")}
                </p>
                <p className="mt-4 font-bold text-interview">
                  {t("terms.contact_email")}: support@jobuz.uz
                </p>
              </div>
